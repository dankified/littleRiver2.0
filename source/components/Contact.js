        ...
        <Form>
          ...
          <Form.Group widths="equal">
            <Form.Field>
              ...
              <Dropdown placeholder="Select Contact Method" search={false} selection options={options} onChange={this.contactOptionChange}/>
            </Form.Field>
            <Form.Input fluid label="Other Contact Option" placeholder="Other" disabled={this.state.otherDisabled}/>
          </Form.Group>
